    ...
    <div className="relative z-2 mb-16 ">
      ...
      >
        <div className="flex-1">
          <div className="small-compact mb-1.5 text-primary-500 max-lg:hidden">
            {index < 10 ? "0" : ""}
            {index}
          </div>
          <div
            className={clsx(
              "h6 text-secondary-800 transition-colors duration-500 max-md:flex max-md:min-h-20 max-md:items-center",
      ...
      <SlideDown>
      {activeId === item.id && (
          <div className="body-3 px-7 py-3.5 text-primary-400">{item.answer}</div>
        )}
      </SlideDown>
      <div
        className={clsx(
